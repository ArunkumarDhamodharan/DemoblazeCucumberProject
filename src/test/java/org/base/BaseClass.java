	...
	public static void getDriver(String browserType) {
		...
		case "Chrome":
			System.setProperty("webdriver.chrome.driver",
					"C:\\Users\\Vy Systems\\git\\DemoblazeCucumberProject\\Drivers\\chromedriver.exe");
			driver = new ChromeDriver();
			break;
		case "Edge":
			System.setProperty("webdriver.Edge.driver",
					"C:\\Users\\Vy Systems\\eclipse-workspace\\WatchFire\\Drivers\\msedgedriver.exe");
			driver = new EdgeDriver();
			break;
		case "Firefox":
			System.setProperty("webdriver.firefox.driver",
					"C:\\Users\\Vy Systems\\eclipse-workspace\\VytcdcSignupPage\\driver\\geckodriver.exe");
...
//  **************************************JavaScript Executer End********************************************	

//  *************************Navigation Commands to Forward Backward and Refresh***************************	
	// to
